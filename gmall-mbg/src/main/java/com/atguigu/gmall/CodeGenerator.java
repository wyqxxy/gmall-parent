...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("C:\\sggworkspace\\code\\gmall-parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("Lfy");
        ...
        dsc.setUrl("jdbc:mysql://192.168.9.110:3316/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
